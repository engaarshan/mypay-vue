		...
		<div v-show="modal" class="font-general-regular fixed inset-0 z-30">
			...
			>
				<transition name="fade-up-down">
					...
					>
						<div
							class="modal max-w-md mx-5 xl:max-w-xl lg:max-w-xl md:max-w-xl bg-white dark:bg-primary-dark max-h-screen shadow-lg flex-row rounded-lg relative"
						>
							<div
							...
							>
								...
								>
									Transaction Form - Fill the form  
								</h5>
								<button
